...
start_time = pd.to_datetime("2001-12-25 00:00:00")
...
for file in os.listdir(directory):
    ...
    if file.startswith("trih") and file.endswith(".nc"):
        ...
        # subset_dataset_trih = dataset_trih.isel(time=[0, 1], Station=[0, 1])
        ...
        # Save the subset dataset to a new NetCDF file
        output_filename = f"trih-scsmCddb-5days.nc"
