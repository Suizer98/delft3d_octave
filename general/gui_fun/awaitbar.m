function [fout,abort] = awaitbar(x,whichbar,varargin)
...
% $Date: 2007/06/07
% $Revision: 11797 $ $Date: 2015-03-12 18:49:50 +0800 (Thu, 12 Mar 2015) $
%
%% Version <http://svnbook.red-bean.com/en/1.5/svn.advanced.props.special.keywords.html>
% Created: 22 Oct 2014
% Created with Matlab version: 8.4.0.150421 (R2014b)

% $Id: awaitbar.m 11797 2015-03-12 10:49:50Z ormondt $
% $Date: 2015-03-12 18:49:50 +0800 (Thu, 12 Mar 2015) $
% $Author: ormondt $
% $Revision: 11797 $
% $HeadURL: https://svn.oss.deltares.nl/repos/openearthtools/trunk/matlab/general/gui_fun/awaitbar.m $
% $Keywords: $
...
%            pos = [screenSize(3)/2-width/2 screenSize(4)/2-height/2 width height];
            pos = [screenSize(3)/2.8-width/2 screenSize(4)/2.8-height/2 width height];
        end
        f = figure(...
            'Units', 'points', ...
            'Position', pos, ...
        ...
        h = uicontrol('Style', 'pushbutton', 'String', 'Abort',...
            ...
            'FontSize',10,'units','Points','Position', [0.8.*width  8 40 22],...
            'Callback', 'f=findobj(''Tag'',''TMWAWaitbar'');t00=get(f,''UserData'');t00(7)=1;set(f,''UserData'',t00)');
        colormap([]);
        axNorm=[.05 .55 .82 .2];
        ...
        uicontrol('Parent',f,...
            'Units','points',...
            'Position',[pos(3).*0.88 pos(4).*0.52 pos(3).*.11 pos(4).*0.20],...
            'String','%',...
            'Style','text',...
            'BackgroundColor', [0.80 0.80 0.80],...
