...
%FILEEXT   Returns EXT from        [PATHSTR,NAME,EXT] = FILEPARTS(FILE).
%
...
% $Id: fileext.m 5104 2011-08-23 10:24:20Z boer_g $
% $Date: 2011-08-23 18:24:20 +0800 (Tue, 23 Aug 2011) $
% $Author: boer_g $
% $Revision: 5104 $
% $HeadURL: https://svn.oss.deltares.nl/repos/openearthtools/trunk/matlab/general/io_fun/fileext.m $
% $Keywords$
