...
% retrieved from matlab file exchange on 6/5/2010. 
% http://www.mathworks.com/matlabcentral/fileexchange/22365
% The retreived function is further modified. Funtion saves about 0.4
% seconds per call 
%
% Use as follows:
%
%         Excel = actxserver ('Excel.Application'); % open Excel
%         for ii = 1:length(fns)
%             filename = fullfile('rootpath',fns(ii).name);
%             Excel.Workbooks.Open(filename);
%             numdata = xlsread1(Excel,filename,'sheet1');
%         end
...
%   $Revision: 4954 $  $Date: 2011-07-29 18:50:17 +0800 (Fri, 29 Jul 2011) $
%=============================================================================
