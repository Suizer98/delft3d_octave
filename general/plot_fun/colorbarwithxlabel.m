function [varargout]=colorbarwithxlabel(colorbartxt,varargin)
%COLORBARWITHXLABEL  (re)draws the colorbar with xlabel below it.
%
%         colorbarwithxlabel(colorbartxt,<ctick>) 
%
...
%      colorbarwithxlabel(colorbartxt,[]   ,arguments)
%      colorbarwithxlabel(colorbartxt,ctick,arguments) 
%
...
%
%      caxis([0 360])
%      [ax, h]=colorbarwithxlabel('wind direction',[0:90:360],'horiz') 
%      set(ax,'YTickLabel',{'E','N','W','S'})
%
%      logticks = [1 2 5 10 20 50]
%      clim(logticks([1 end]))
%      [ax, h]=colorbarwithxlabel('SPM [mg/l]',logticks,'horiz');
...
% $Id: colorbarwithxlabel.m 5885 2012-03-27 08:45:00Z boer_g $
% $Date: 2012-03-27 16:45:00 +0800 (Tue, 27 Mar 2012) $
% $Author: boer_g $
% $Revision: 5885 $
% $HeadURL: https://svn.oss.deltares.nl/repos/openearthtools/trunk/matlab/general/plot_fun/colorbarwithxlabel.m $
% $Keywords: $
