 ...
 */
FARPROC WINAPI ucit_netcdfDelayLoadWin32FailureHook (unsigned dliNotify, PDelayLoadInfo pdli)
{
...
PfnDliHook __pfnDliFailureHook2 = ucit_netcdfDelayLoadWin32FailureHook;
#else
PfnDliHook __pfnDliFailureHook = ucit_netcdfDelayLoadWin32FailureHook;
#endif
