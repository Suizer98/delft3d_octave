function TASS_plotDensityDischargeWeir(varargin)
% TASS_PLOTDENSITYDISCHARGEWEIR  Routine plots data retrieved by
% TASS_readDensityDischargeWeir.m
%
...
% $Id: TASS_plotDensityDischargeWeir.m 2616 2010-05-26 09:06:00Z geer $
% $Date: 2010-05-26 17:06:00 +0800 (Wed, 26 May 2010) $
% $Author: geer $
% $Revision: 2616 $
% $HeadURL: https://svn.oss.deltares.nl/repos/openearthtools/trunk/matlab/applications/tass/TASS_plotDensityDischargeWeir.m $
% $Keywords:
...
title(OPT.data_info{2})
xlabel([OPT.data_units{1}])
ylabel([OPT.data_units{2}])
