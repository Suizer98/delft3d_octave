...
%   $Revision: 17322 $ $Date: 2021-06-09 03:02:18 +0800 (Wed, 09 Jun 2021) $
...
switch ( mv )
    ...
    case { '14', '2006a', '2006b', '2007a', '2007b', '2008a', '2008b', '2009a', '2009b', '2010a', '2010b', '2011a', '2011b', '2012a'} % set Timeout for old Matlab versions
        ...
        % Commented next two lines because they don't work with Matlab 2010b
        %narginchk(2,4)
        %nargoutchk(0,2)
        if ~ischar(urlChar)
        ...
        urlConnection.setReadTimeout(T); % timeout in 2000 ms 
