function  [x,y,utmzone_total, utmzone_parts] = ddb_deg2utm(Lat,Lon)
% -------------------------------------------------------------------------
...
for i=1:n1
   ...
   x(i)=xx;
   y(i)=yy;
   utmzone_total(i,:)=sprintf('%02d %c',Huso,Letra);
   utmzone_parts.number(i,:) = Huso;
   if la > 0;
       utmzone_parts.lat(i,:) = 'N';
   else
       utmzone_parts.lat(i,:) = 'S';
   end
