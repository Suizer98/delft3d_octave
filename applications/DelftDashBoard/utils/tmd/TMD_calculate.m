...
% correct NaNs if possible
       ...
       z1(inan)=BLinterp(x,y,z,xt(inan),yt(inan));
       amp(ic2,:)=abs(z1)';
...
% correct NaNs if possible
       ...
       u1(inan)=BLinterp(x,y,u,xt(inan),yt(inan));
       amp(ic2,:)=abs(u1)';
...
% correct NaNs if possible
       ...
       v1(inan)=BLinterp(x,y,v,xt(inan),yt(inan));
       amp(ic2,:)=abs(v1)';
...
% ALL nh==1
 ...
 for k=1:L
  ...
  [yy(k),mm(k),dd(k)]=cor_date(yy(k),mm(k),dd(k),uT);
