function handles = ddb_sfincs_plot_bathymetry(handles, option, varargin)
...
vis=vis*handles.model.sfincs.menuview.bathymetry;
...
switch lower(option)
    ...
    case{'plot'}
        ...
        if size(handles.model.sfincs.domain(id).gridz,1)>0
            ...
            x=handles.model.sfincs.domain(id).xg;
            y=handles.model.sfincs.domain(id).yg;
            z0=handles.model.sfincs.domain(id).gridz;
            z=nan(size(x));
            z(1:end-1,1:end-1)=z0;
