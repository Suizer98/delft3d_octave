...
%DDB_SAVECRSFILE  One line description goes here.
%
...
%%
fid=fopen(handles.model.delft3dflow.domain(id).crsFile,'w');
for i=1:handles.model.delft3dflow.domain(id).nrCrossSections
    ...
    name=handles.model.delft3dflow.domain(id).crossSections(i).name;
