...
tc.asymmetry_option='schwerdt1979';

switch tc.track(1).method
    case 10
        % Pdrop (PAGASA-JMA method, using Fujita wind profile. Rmax from look-up table)
        tc.asymmetry_option='jma';
        tc.phi_spiral=30;
end
...
for it=1:nt
    ...
    ux=dx/dt;
    uy=dy/dt;
    switch lower(tc.asymmetry_option)
        case{'schwerdt1979'}
...
%% Set default to Holland (1980)
for it=1:nt
    tc.track(it).wind_profile='holland1980';
end
...
for it=1:nt
    ...
    if length(tc.track(it).quadrant)==1 || tc.track(it).method~=2 % FIX THIS
        ...
        switch lower(tc.track(it).wind_profile)
            case{'holland1980'}               
                % A and B used for entire circle
                a=tc.track(it).quadrant(1).a;
                b=tc.track(it).quadrant(1).b;
                pn=1012;
                pc=pn-0.01*tc.track(it).pdrop;
                [vr,pr]=holland1980(r,pn,pc,a,b,'ab','rhoa',rhoa);
                pd=pn-pr;
            case{'fujita'}
                pn=1012;
                pc=pn-0.01*tc.track(it).pdrop;
                ...
                lat=tc.track(it).y;
                c1=0.7;
                [vr,pr]=fujita(r,pn,pc,r0,lat,c1,'rhoa',rhoa);
                pd=pn-pr;
        end
...
%    end
    ...
    vx=wind_speed.*cos(wind_to_direction_cart*pi/180)+tc.track(it).u_prop*efold;
    vy=wind_speed.*sin(wind_to_direction_cart*pi/180)+tc.track(it).v_prop*efold;
    dr=atan2(vy,vx);
    dr=1.5*pi-dr;
...
%%
function tc=method10(tc,it)

% Lookup table for R0 (we set it in Rmax, but this is NOT the same).
p=[   1.0040000e+03   1.0030000e+03   1.0020000e+03   1.0010000e+03   1.0000000e+03   9.9900000e+02   9.9800000e+02   9.9700000e+02   9.9600000e+02   9.9500000e+02   9.9400000e+02   9.9300000e+02   9.9200000e+02   9.9100000e+02   9.9000000e+02   9.8900000e+02   9.8800000e+02   9.8700000e+02   9.8600000e+02   9.8500000e+02   9.8400000e+02   9.8300000e+02   9.8200000e+02   9.8100000e+02   9.8000000e+02   9.7900000e+02   9.7800000e+02   9.7700000e+02   9.7600000e+02   9.7500000e+02   9.7400000e+02   9.7300000e+02   9.7200000e+02   9.7100000e+02   9.7000000e+02   9.6900000e+02   9.6800000e+02   9.6700000e+02   9.6600000e+02   9.6500000e+02   9.6400000e+02   9.6300000e+02   9.6200000e+02   9.6100000e+02   9.6000000e+02   9.5900000e+02   9.5800000e+02   9.5700000e+02   9.5600000e+02   9.5500000e+02   9.5400000e+02   9.5300000e+02   9.5200000e+02   9.5100000e+02   9.5000000e+02   9.4900000e+02   9.4800000e+02   9.4700000e+02   9.4600000e+02   9.4500000e+02   9.4400000e+02   9.4300000e+02   9.4200000e+02   9.4100000e+02   9.4000000e+02   9.3900000e+02   9.3800000e+02   9.3700000e+02   9.3600000e+02   9.3500000e+02   9.3400000e+02   9.3300000e+02   9.3200000e+02   9.3100000e+02   9.3000000e+02   9.2900000e+02   9.2800000e+02   9.2700000e+02   9.2600000e+02   9.2500000e+02   9.2400000e+02   9.2300000e+02   9.2200000e+02   9.2100000e+02   9.2000000e+02   9.1900000e+02   9.1800000e+02   9.1700000e+02   9.1600000e+02   9.1500000e+02   9.1400000e+02   9.1300000e+02   9.1200000e+02   9.1100000e+02   9.1000000e+02];
r0=[   1.3200000e+02   1.3100000e+02   1.3000000e+02   1.2900000e+02   1.2700000e+02   1.2600000e+02   1.2500000e+02   1.2300000e+02   1.2200000e+02   1.2100000e+02   1.1900000e+02   1.1800000e+02   1.1700000e+02   1.1500000e+02   1.1400000e+02   1.1300000e+02   1.1200000e+02   1.1000000e+02   1.0900000e+02   1.0800000e+02   1.0600000e+02   1.0500000e+02   1.0400000e+02   1.0200000e+02   1.0100000e+02   1.0000000e+02   9.9000000e+01   9.7000000e+01   9.6000000e+01   9.5000000e+01   9.3000000e+01   9.2000000e+01   9.1000000e+01   8.9000000e+01   8.8000000e+01   8.7000000e+01   8.5000000e+01   8.4000000e+01   8.3000000e+01   8.2000000e+01   8.0000000e+01   7.9000000e+01   7.8000000e+01   7.6000000e+01   7.5000000e+01   7.4000000e+01   7.2000000e+01   7.1000000e+01   7.0000000e+01   6.9000000e+01   6.7000000e+01   6.6000000e+01   6.5000000e+01   6.4000000e+01   6.4000000e+01   6.3000000e+01   6.3000000e+01   6.3000000e+01   6.2000000e+01   6.1000000e+01   6.1000000e+01   6.0000000e+01   5.9000000e+01   5.9000000e+01   5.8000000e+01   5.8000000e+01   5.7000000e+01   5.6000000e+01   5.6000000e+01   5.5000000e+01   5.5000000e+01   5.4000000e+01   5.3000000e+01   5.3000000e+01   5.2000000e+01   5.1000000e+01   5.1000000e+01   5.0000000e+01   5.0000000e+01   4.9000000e+01   4.8000000e+01   4.8000000e+01   4.7000000e+01   4.7000000e+01   4.6000000e+01   4.5000000e+01   4.5000000e+01   4.4000000e+01   4.3000000e+01   4.3000000e+01   4.2000000e+01   4.2000000e+01   4.1000000e+01   4.0000000e+01   4.0000000e+01];
p=[1100 p 500];
r0=[r0(1) r0 r0(end)];
pc=(101200-tc.track(it).pdrop)*0.01;
tc.track(it).rmax=interp1(p,r0,pc);
tc.track(it).wind_profile='fujita';
tc.asymmetry_option='jma';
