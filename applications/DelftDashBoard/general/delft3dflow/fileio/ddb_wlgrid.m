function varargout=ddb_wlgrid(cmd,varargin)
...
%   and returns X coordintes, Y coordinates, grid ddb_enclosure and coordinate
...
%   ddb_enclosure array (in this order), file name, file format, coordinate
...
%   $Id: ddb_wlgrid.m 5936 2012-04-06 12:04:17Z ormondt $
...
if fid>0
   ...
   %warning('Grid ddb_enclosure not found.');
   [M,N]=size(GRID.X);
