...
% $Date: 2013-04-24 04:32:15 +0800 (Wed, 24 Apr 2013) $
% $Author: lescins $
% $Revision: 8496 $
...
for it=1:nt
    ...
    switch lower(par)
        ...
        case{'temperature'}
            ...
            data=nc_varget(fname,'temperature',[0 0 imin-1 jmin-1],[1 nd id jd]);
            if ndims(data)==3
        ...
        case{'salinity'}
            ...
            data=nc_varget(fname,'salinity',[0 0 imin-1 jmin-1],[1 nd id jd]);
            if ndims(data)==3
                data=permute(data,[2 3 1]);
                data(:,:,:,1)=data;
            else
        ...
        case{'current_u'}
            ...
            data=nc_varget(fname,'u',[0 0 imin-1 jmin-1],[1 nd id jd]);
            if ndims(data)==3
                data=permute(data,[2 3 1]);
                data(:,:,:,1)=data;
            else
        ...
        case{'current_v'}
            ...
            data=nc_varget(fname,'v',[0 0 imin-1 jmin-1],[1 nd id jd]);
            if ndims(data)==3
                data=permute(data,[2 3 1]);
                data(:,:,:,1)=data;
            else
