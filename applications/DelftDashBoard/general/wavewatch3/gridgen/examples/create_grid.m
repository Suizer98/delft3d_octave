...
homedir='d:\programs\wavewatch3';

  bin_dir = [homedir filesep 'gridgen' filesep 'bin' filesep];             % matlab scripts location
  ref_dir = [homedir filesep 'gridgen' filesep 'reference_data' filesep];  % reference data location
  out_dir = ['swindian' filesep];                                       % output directory
...
% 0.b Design grid parameters
  ...
  fname = 'swindian';              % file name prefix 
