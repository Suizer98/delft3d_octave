function varargout = EditAnimationSettings(varargin)
% EDITANIMATIONSETTINGS M-file for EditAnimationSettings.fig
%      EDITANIMATIONSETTINGS, by itself, creates a new EDITANIMATIONSETTINGS or raises the existing
%      singleton*.
%
%      H = EDITANIMATIONSETTINGS returns the handle to a new EDITANIMATIONSETTINGS or the handle to
%      the existing singleton*.
%
%      EDITANIMATIONSETTINGS('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in EDITANIMATIONSETTINGS.M with the given input arguments.
%
%      EDITANIMATIONSETTINGS('Property','Value',...) creates a new EDITANIMATIONSETTINGS or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before EditAnimationSettings_OpeningFunction gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to EditAnimationSettings_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help EditAnimationSettings

% Last Modified by GUIDE v2.5 03-Feb-2011 16:39:25

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @EditAnimationSettings_OpeningFcn, ...
                   'gui_OutputFcn',  @EditAnimationSettings_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before EditAnimationSettings is made visible.
function EditAnimationSettings_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to EditAnimationSettings (see VARARGIN)

% Choose default command line output for EditAnimationSettings
...
% UIWAIT makes EditAnimationSettings wait for user response (see UIRESUME)
uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = EditAnimationSettings_OutputFcn(hObject, eventdata, handles) 
