function varargout = AddDatasetTekalTime(varargin)
% ADDDATASETTEKALTIME M-file for AddDatasetTekalTime.fig
%      ADDDATASETTEKALTIME, by itself, creates a new ADDDATASETTEKALTIME or raises the existing
%      singleton*.
%
%      H = ADDDATASETTEKALTIME returns the handle to a new ADDDATASETTEKALTIME or the handle to
%      the existing singleton*.
%
%      ADDDATASETTEKALTIME('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in ADDDATASETTEKALTIME.M with the given input arguments.
%
%      ADDDATASETTEKALTIME('Property','Value',...) creates a new ADDDATASETTEKALTIME or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before AddDatasetTekalTime_OpeningFunction gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to AddDatasetTekalTime_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help AddDatasetTekalTime
...
gui_State = struct('gui_Name',       mfilename, ...
                   ...
                   'gui_OpeningFcn', @AddDatasetTekalTime_OpeningFcn, ...
                   'gui_OutputFcn',  @AddDatasetTekalTime_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before AddDatasetTekalTime is made visible.
function AddDatasetTekalTime_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to AddDatasetTekalTime (see VARARGIN)
 
% Choose default command line output for AddDatasetTekalTime
...
% UIWAIT makes AddDatasetTekalTime wait for user response (see UIRESUME)
uiwait(handles.figure1);
 
 
% --- Outputs from this function are returned to the command line.
function varargout = AddDatasetTekalTime_OutputFcn(hObject, eventdata, handles)
...
if NewDatasetName(handles.DataProperties,handles.NrAvailableDatasets,name)
    ...
    handles.DataProperties(nr).FileType='TekalTime';
    ...
    handles.DataProperties=ImportTekalTime(handles.DataProperties,nr);
