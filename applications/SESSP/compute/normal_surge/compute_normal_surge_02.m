...
if ~isempty(varargin)
    ...
    cshift=compute_normal_surge_cross_track_shift_02(shelf_width,vmax,rmax,phi,r35,a,foreward_speed);
    ashift=compute_normal_surge_along_track_shift_02(shelf_width,phi,a);
