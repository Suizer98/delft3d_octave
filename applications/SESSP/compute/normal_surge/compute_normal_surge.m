...
if ~isempty(varargin)
    ...
    redfac=compute_normal_surge_reduction_factor(shelf_width,rmax,phi,foreward_speed);
    redext=compute_normal_surge_reduction_extent(shelf_width,phi,rmax,r35,a);
    cshift=compute_normal_surge_cross_track_shift(shelf_width,vmax,rmax,phi,r35,a,foreward_speed);
    ashift=compute_normal_surge_along_track_shift(shelf_width,phi,a);
    lrfac=compute_normal_surge_land_reduction_factor(vmax,phi,a,shelf_width,rmax,r35);
end
