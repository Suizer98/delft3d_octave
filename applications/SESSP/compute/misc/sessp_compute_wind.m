function [vnor,vtan,r,r0]=compute_wind(t,xc,yc,phi_c,te,xe,ye,vmax,rmax,r35,phi_in,lat,cshift,ashift,varargin)
    ...
    if ischar(varargin{ii})
        switch lower(varargin{ii})
            ...
            case{'asymangle'}
                phi_a=varargin{ii+1};
            case{'forewardspeed'}
                forewardspeed=varargin{ii+1};
            case{'trackangle'}
                trackangle=varargin{ii+1};
        end
    end
end
...
if vmax1(1)>1.2*35*1.852/3.6 && r35(1)>1.2*rmax(1)   
