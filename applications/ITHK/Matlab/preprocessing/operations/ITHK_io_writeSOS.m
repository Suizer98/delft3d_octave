function ITHK_io_writeSOS(filename, varargin)
%write SOS : Writes a unibest sources and sinks file
%
%   Syntax:
%     ITHK_io_writeSOS(filename, SOSdata)
%
%   Input:
...
% 
%   Example:
%     ITHK_io_writeSOS(filename, {[1000,2000,0,22000,0],[500,1000,0,12000,0]})  % at x=1000,y=2000,Qs=22000 and at x=500,y=1000,Qs=12000
%     ITHK_io_writeSOS(filename, {[1000,2000,1,0,1],[500,1000,1,0,2]})  % at x=1000,y=2000,use tabfile1,column1 and at x=500,y=1000,use tabfile1,column2
%
%   See also 
...
% $Id: ITHK_io_writeSOS.m 10805 2014-06-04 08:10:15Z boer_we $
% $Date: 2014-06-04 16:10:15 +0800 (Wed, 04 Jun 2014) $
% $Author: boer_we $
% $Revision: 10805 $
% $HeadURL: https://svn.oss.deltares.nl/repos/openearthtools/trunk/matlab/applications/ITHK/Matlab/preprocessing/operations/ITHK_io_writeSOS.m $
% $Keywords: $
