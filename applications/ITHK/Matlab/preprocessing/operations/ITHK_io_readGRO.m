function GROdata = ITHK_io_readGRO(filename)
%GROdata = readGRO(filename)
%Writes a unibest groyne file
%
%   Syntax:
%     function ITHK_io_readGRO(filename)
% 
%   Input:
...
%
%   Example:
%     GROdata = ITHK_io_readGRO('test.gro')
%
%   See also 
...
% $Id: ITHK_io_readGRO.m 7220 2012-09-10 16:14:18Z huism_b $
% $Date: 2012-09-11 00:14:18 +0800 (Tue, 11 Sep 2012) $
% $Author: huism_b $
% $Revision: 7220 $
% $HeadURL: https://svn.oss.deltares.nl/repos/openearthtools/trunk/matlab/applications/ITHK/Matlab/preprocessing/operations/ITHK_io_readGRO.m $
% $Keywords: $
