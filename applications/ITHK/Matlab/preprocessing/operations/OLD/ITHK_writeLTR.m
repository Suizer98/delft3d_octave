function ITHK_writeLTR(filename, shoreline, locations, closure_depth, pro_file, cfs_file, cfe_file, sco_file, varargin)
%write LTR : Writes a unibest lt-run specification file (automatically computing coast angle)
%
%   Syntax:
%     function ITHK_writeLTR(filename, shoreline, locations, closure_depth, pro_file, cfs_file, cfe_file, sco_file, ray_file)
% 
%   Input:
...
%
%   Example:
%     ITHK_writeLTR('test.ltr', 20, [], 8, 'diep', 'bijker', 'waves', 'baseline')
%     ITHK_writeLTR('test.ltr', 'shore.pol', 'loc.ldb', 5, 'diep', 'bijker', 'waves', 'baseline', 'baseline')
%
%   See also 
...
% $Id: ITHK_writeLTR.m 6382 2012-06-12 16:00:17Z boer_we $
% $Date: 2012-06-13 00:00:17 +0800 (Wed, 13 Jun 2012) $
% $Author: boer_we $
% $Revision: 6382 $
% $HeadURL: https://svn.oss.deltares.nl/repos/openearthtools/trunk/matlab/applications/ITHK/Matlab/preprocessing/operations/OLD/ITHK_writeLTR.m $
% $Keywords: $
