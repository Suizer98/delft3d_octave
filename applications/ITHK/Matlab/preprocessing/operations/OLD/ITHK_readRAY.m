function [RAYdata] = ITHK_readRAY(RAYfilename)
...
%
%   Example:
%     [RAYdata] = ITHK_readRAY('test.ray')
%     [RAYdata] = ITHK_readRAY({'test1.ray'},{'test2.ray'})
%     [RAYdata] = ITHK_readRAY(dir('*.ray'))
%
%   See also 
...
% $Id: ITHK_readRAY.m 6382 2012-06-12 16:00:17Z boer_we $
% $Date: 2012-06-13 00:00:17 +0800 (Wed, 13 Jun 2012) $
% $Author: boer_we $
% $Revision: 6382 $
% $HeadURL: https://svn.oss.deltares.nl/repos/openearthtools/trunk/matlab/applications/ITHK/Matlab/preprocessing/operations/OLD/ITHK_readRAY.m $
% $Keywords: $
