function [x,y,ray_file]=ITHK_readGKL(GKLfilename)
%read GKL : Reads a UNIBEST gkl-file
%   
%   Syntax:
%     function [x,y,rayfiles]=ITHK_readGKL(GKLfilename)
%   
%   Input:
...
% $Id: ITHK_readGKL.m 7632 2012-11-04 20:09:08Z boer_we $
% $Date: 2012-11-05 04:09:08 +0800 (Mon, 05 Nov 2012) $
% $Author: boer_we $
% $Revision: 7632 $
% $HeadURL: https://svn.oss.deltares.nl/repos/openearthtools/trunk/matlab/applications/ITHK/Matlab/preprocessing/operations/OLD/ITHK_readGKL.m $
% $Keywords: $
