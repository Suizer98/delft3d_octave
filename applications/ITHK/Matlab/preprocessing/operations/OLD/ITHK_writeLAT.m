function ITHK_writeLAT(filename, xlimits, ylimits, land_polygon, polygons, text_block, point_block, color_info)
...
% 
%   Example:
%     ITHK_writeLAT('test.lat', xlimits, ylimits, [], {[20,1;10,2],[220,95;150,72;80,20]}, [], point_block, [])
% 
%   See also 
...
% $Id: ITHK_writeLAT.m 6382 2012-06-12 16:00:17Z boer_we $
% $Date: 2012-06-13 00:00:17 +0800 (Wed, 13 Jun 2012) $
% $Author: boer_we $
% $Revision: 6382 $
% $HeadURL: https://svn.oss.deltares.nl/repos/openearthtools/trunk/matlab/applications/ITHK/Matlab/preprocessing/operations/OLD/ITHK_writeLAT.m $
% $Keywords: $
