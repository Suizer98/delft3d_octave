function ITHK_writeRAY(inhoudRAY)
...
%
%   Example:
%     inhoudRAY = ITHK_readRAY('test.ray')
%     ITHK_writeRAY(inhoudRAY);
%
%   See also 
...
% $Id: ITHK_writeRAY.m 6382 2012-06-12 16:00:17Z boer_we $
% $Date: 2012-06-13 00:00:17 +0800 (Wed, 13 Jun 2012) $
% $Author: boer_we $
% $Revision: 6382 $
% $HeadURL: https://svn.oss.deltares.nl/repos/openearthtools/trunk/matlab/applications/ITHK/Matlab/preprocessing/operations/OLD/ITHK_writeRAY.m $
% $Keywords: $
