function ITHK_writeBCI(filename, xy, varargin)
%write BCI : Writes a unibest internal wave boundary file
%
%   Syntax:
%     function ITHK_writeBCI(filename, xy, Yoffset, BlockPerc, Yreference)
% 
%   Input:
...
%
%   Example:
%     ITHK_writeBCI('test.bci', [32000,56000] , 55, 3.5, 0)
%     ITHK_writeBCI('test.bci', [32000,56000])
%
%   See also 
...
% $Id: ITHK_writeBCI.m 6382 2012-06-12 16:00:17Z boer_we $
% $Date: 2012-06-13 00:00:17 +0800 (Wed, 13 Jun 2012) $
% $Author: boer_we $
% $Revision: 6382 $
% $HeadURL: https://svn.oss.deltares.nl/repos/openearthtools/trunk/matlab/applications/ITHK/Matlab/preprocessing/operations/OLD/ITHK_writeBCI.m $
% $Keywords: $
