function data=ITHK_readPRN(varargin)
%read PRN : Reads PRN-files and puts data into a struct
%   
%   Syntax:
%     function [data]=ITHK_readPRN(PRNfilename)
%   
%   Input:
...
% $Id: ITHK_readPRN.m 6382 2012-06-12 16:00:17Z boer_we $
% $Date: 2012-06-13 00:00:17 +0800 (Wed, 13 Jun 2012) $
% $Author: boer_we $
% $Revision: 6382 $
% $HeadURL: https://svn.oss.deltares.nl/repos/openearthtools/trunk/matlab/applications/ITHK/Matlab/preprocessing/operations/OLD/ITHK_readPRN.m $
% $Keywords: $
