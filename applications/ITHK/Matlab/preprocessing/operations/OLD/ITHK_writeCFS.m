function ITHK_writeCFS(filename, transp_formula, varargin)
...
%
%   Example:
%     ITHK_writeCFS('test.cfs', 'Bijker', D50, D90, rc, wval, crit_d, b_d1, crit_s, b_d2)
%     ITHK_writeCFS('test.cfs', 'Rijn', D50, D90, rho, rc, rw, wval, visc, alfa, A, por)
%     ITHK_writeCFS('test.cfs', 'Gravel', Dn50, R, rho, shields, n)
%     ITHK_writeCFS('test.cfs', 'Cerc', A,gamma)
%
%   See also 
...
% $Id: ITHK_writeCFS.m 6382 2012-06-12 16:00:17Z boer_we $
% $Date: 2012-06-13 00:00:17 +0800 (Wed, 13 Jun 2012) $
% $Author: boer_we $
% $Revision: 6382 $
% $HeadURL: https://svn.oss.deltares.nl/repos/openearthtools/trunk/matlab/applications/ITHK/Matlab/preprocessing/operations/OLD/ITHK_writeCFS.m $
% $Keywords: $
