function [Profiles,sheets,fn,Scenarios,Rp_in,Hs_in,Tp_in,D50,limits,lwb]= KPZSS_DUROS_input(dir_profiles,dir_hbc)

%   --------------------------------------------------------------------
%   Matlab script to load input for KPZSS_DUROS_visualisation
%   M.Q.T. Groenewegen 
%   maurits.groenewegen@rws.nl
%   03-nov-2021
%
%   Syntax:
%   [Profiles,sheets,fn,Scenarios,Waterlevel,Waveheight,Waveperiod,
%   Grainsize,limits]= KPZSS_DUROS_input(dir_profiles,dir_hbc)
%
%   Input:
...
%   Rp          -    Maximum storm search level
%   Hs          -    Significant wave height during the storm
%   Tp          -    Peak wave period during the storm
%   D50         -    Grain size
...
% Scenario names
Scenarios = ["S0","S6_1","S6_2","S6_3","S1_1","S1_2","S1_3","S2_1","S2_2","S2_3","S3_1","S3_2","S3_3","S4_1","S4_2","S4_3","S5_1","S5_2","S5_3"];
