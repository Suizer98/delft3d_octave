function flowarray = waq2flow2D(WAQarray,pointerarray,varargin)
%WAQ2FLOW2D   Maps 1D WAQ array to 2D FlOW matrix
%
% flowarray = waq2flow2D(WAQarray,pointerarray)
%
...
% 
% See also:
% WAQ2FLOW3D, FLOW2WAQ3D, FLOW2WAQ3D_COUPLING, DELWAQ
...
% $Id: waq2flow2d.m 372 2009-04-16 15:50:08Z boer_g $
% $Date: 2009-04-16 23:50:08 +0800 (Thu, 16 Apr 2009) $
% $Author: boer_g $
% $Revision: 372 $
% $HeadURL: https://svn.oss.deltares.nl/repos/openearthtools/trunk/matlab/applications/delft3d/waq/waq2flow2d.m $
   ...
   for n=1:size(pointerarray,2)
      ...
      flowarray(m,n) = WAQarray(round(pointerarray(m,n)));
      end
   end
   end
