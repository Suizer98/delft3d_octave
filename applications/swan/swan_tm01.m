function Tm01 = swan_tm01(f,E,varargin)
%SWAN_TM01                calculates average absolute period Tm01 from wave spectrum as in SWAN
%
% Tm01 = SWAN_TM01(f,E,<pwtail>)
%
% SWAN_TM01 accounts for the significant effect of the high frequency tail!!
...
% $Id: swan_tm01.m 11618 2015-01-09 09:53:00Z gerben.deboer.x $
% $Date: 2015-01-09 17:53:00 +0800 (Fri, 09 Jan 2015) $
% $Author: gerben.deboer.x $
% $Revision: 11618 $
% $HeadURL: https://svn.oss.deltares.nl/repos/openearthtools/trunk/matlab/applications/swan/swan_tm01.m $
   ...
   %  command GEN3 JANSEN : [pwtail] = 5   
      ...
      m1hfr  = EFTAIL * f(end) * EADD;
      if OPT.disp
      disp(['%tail on m1 = ',pad(num2str(100*m1hfr/m1,'%3.2f'),' ',-6),'% on m1=',num2str(m1)])
      end
      m1     = m1 + m1hfr;
