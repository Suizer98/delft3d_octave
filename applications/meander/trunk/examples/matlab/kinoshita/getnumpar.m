...
numpar.sweacc = 1e-8;              % accuracy cutoff for SWE calculation
...
numpar.routyp = 0;                 % 0 = straight channel friction factor
...
numpar.bedtype = 0;                % 0 = flat bed   (A=0)
                                   % 1 = river bed  (A=3)
                                   % 2 = A/R from calculation
                                   % 3 = A/R from input
