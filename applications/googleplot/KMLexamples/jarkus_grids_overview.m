...
url           = 'http://opendap.deltares.nl:8080/thredds/catalog/opendap/rijkswaterstaat/jarkus/grids/';
KMLbaseString = 'http://opendap.deltares.nl:8080/opendap/rijkswaterstaat/jarkus/grids/'; % where kml's are stored
...
%% set options
OPT.fileName         = 'Jarkus Grids overview.kml';
OPT.kmlName          = 'Jarkus Grids overview';
OPT.lineWidth        = 1;
OPT.lineColor        = [0 0 0];
OPT.lineAlpha        = 1;
OPT.openInGE         = false;
OPT.reversePoly      = false;
OPT.description      = '<a href="http://www.rijkswaterstaat.nl">Rijkswaterstaat</a> JarKus grids provided by <a href="http://www.openearth.nl"> OpenEarthTools</a>';
OPT.text             = '';
