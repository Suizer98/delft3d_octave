...
%$HeadURL: https://svn.oss.deltares.nl/repos/openearthtools/trunk/matlab/applications/ELV/trunk/test/scripts/flow_steady_energy_euler.m $
%
...
function [U,H]=flow_steady_energy_euler(qwup,Hdown,Cf,etab,input,fid_log,kt)
