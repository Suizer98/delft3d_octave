...
%$HeadURL: https://svn.oss.deltares.nl/repos/openearthtools/trunk/matlab/applications/ELV/trunk/main/backwater_step_rect.m $
%
...
H = h - input.grd.dx*(ib - Cf.*Q.^2./(B.^2.*input.mdv.g.*h.^3)+Q.^2./(input.mdv.g*B^3.*h.^2).*dBdx)./(1-Q.^2./(B.^2.*input.mdv.g.*h.^3));
end
