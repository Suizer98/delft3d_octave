...
%$Author: chavarri $
%$Id: flow_steady_energy_euler.m 16592 2020-09-16 17:32:43Z chavarri $
%$HeadURL: https://svn.oss.deltares.nl/repos/openearthtools/trunk/matlab/applications/ELV/trunk/main/flow_steady_energy_euler.m $
%
...
%
%180704
%   -V. Correction of boundary condition

function [U,H]=flow_steady_energy_euler(qwup,Hdown,Cf,etab,input)
...
Sf_ce=Cf(1,nx)*(qw(1,nx)/(H_ce))^2*(1/(g*H_ce)); %friction slope at cell edge

%march first dx/2 to get to cell centre of last cell
kx=nx;
Energy(1,kx)=Energy_ce+dx/2*Sf_ce;
