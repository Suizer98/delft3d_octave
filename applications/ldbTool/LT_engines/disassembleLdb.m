function [ldbCell, ldbBegin, ldbEnd, ldbIn]=disassembleLdb(ldbIn)
%DISASSEMBLELDB Disassemble a landboundary into its segments
%
% DISASSEMBLELDB returns the segments of a landboundary and the start and
% end points of each segment. A segment is a section in a landboundary file
% between '999.999 999.999' lines.
%
% Syntax:
% [ldbCell, ldbBegin, ldbEnd, ldbIn]=disassembleLdb(ldbIn)
%
