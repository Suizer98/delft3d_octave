function REVdata = readREV(filename)
%REVdata = readREV(filename)
%Reads a unibest revetment file
%
%   Syntax:
%     function readREV(filename)
% 
%   Input:
...
% $Id: readREV.m 10866 2014-06-19 08:20:42Z huism_b $
% $Date: 2014-06-19 16:20:42 +0800 (Thu, 19 Jun 2014) $
% $Author: huism_b $
% $Revision: 10866 $
% $HeadURL: https://svn.oss.deltares.nl/repos/openearthtools/trunk/matlab/applications/unibest/fileio/readREV.m $
% $Keywords: $
