...
%     x = [1:10:1000]';
%     y = x.^1.2;
%     writeMDA2('test.mda', [x,y]);
%     writeMDA2('test.mda', [x,y], [x*0+20], [x*0]);
%
%   See also 
...
% $Id: writeMDA2.m 8631 2013-05-16 14:22:14Z heijer $
% $Date: 2013-05-16 22:22:14 +0800 (Thu, 16 May 2013) $
% $Author: heijer $
% $Revision: 8631 $
% $HeadURL: https://svn.oss.deltares.nl/repos/openearthtools/trunk/matlab/applications/unibest/fileio/writeMDA2.m $
% $Keywords: $
