function writeREV(rev_filename, revetment, varargin)
%write REV : Writes a unibest rev-file (can also compute cross-shore distance between reference line and revetment)
%
%   Syntax:
%     function writeREV(filename, revetment, revtype, reference_line, dx)
%     OR
%     function writeREV(filename, revetment, revtype, y_offset)
% 
...
% 
%   Example:
%     writeREV('default.rev', 'revetment.pol', 1, 'D:\reference_line.ldb')             % option 1
%     writeREV('default.rev', 'revetment.pol', 1, 'D:\reference_line.ldb', 0.05)       % option 2
%
%   See also 
...
% $Id: writeREV.m 13439 2017-07-04 19:37:19Z huism_b $
% $Date: 2017-07-05 03:37:19 +0800 (Wed, 05 Jul 2017) $
% $Author: huism_b $
% $Revision: 13439 $
% $HeadURL: https://svn.oss.deltares.nl/repos/openearthtools/trunk/matlab/applications/unibest/fileio/writeREV.m $
% $Keywords: $
