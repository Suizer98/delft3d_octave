function writeSOS(filename, varargin)
%write SOS : Writes a unibest sources and sinks file
%
%   Syntax:
%     writeSOS(filename, SOSdata)
%
%   Input:
...
% 
%   Example:
%     writeSOS(filename, {[1000,2000,0,22000,0],[500,1000,0,12000,0]})  % at x=1000,y=2000,Qs=22000 and at x=500,y=1000,Qs=12000
%     writeSOS(filename, {[1000,2000,1,0,1],[500,1000,1,0,2]})  % at x=1000,y=2000,use tabfile1,column1 and at x=500,y=1000,use tabfile1,column2
%
%   See also 
