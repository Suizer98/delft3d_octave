...
if istring>0
    ...
    data.x=handles.datasets(nr).dataset.x(istring);
    data.y=handles.datasets(nr).dataset.y(istring);
    data.rotation=handles.datasets(nr).dataset.rotation(istring);
    data.curvature=handles.datasets(nr).dataset.curvature(istring);
