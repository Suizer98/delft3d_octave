clear all;close all
T=12.5*3600;nttide=50;n=70;ncont=10;nram=700;nstep=700/n+1;
h0=10;hsh=2;
L=200;
qmean=-1;
qamp=10;
...
for imorf=1:nstep
   ...
   for icont=1:ncont
      ...
      dSxdxavg=Sxtot/L;
      zb2(it+1)=zb2(it)-dSxdxavg*n/ncont*T;
      zb2(it+1)=min(zb2(it+1),-0.1);
      it=it+1;
      t2(it)=(it-1)*n/ncont*T;
   end
end
...
figure(2)
fac=3600*24;
%p=plot(t/fac,zb1(1:nt),'k',t2/fac,zb2,'r-',t3/fac,zb3(1:length(t3)),'b',t3e/fac,zb3e,'b*',t4e/fac,zb4e,'g*')
