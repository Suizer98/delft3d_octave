...
%$Author: chavarri $
%$Id: colorbarlegend_V.m 16571 2020-09-08 12:39:17Z chavarri $
%$HeadURL: https://svn.oss.deltares.nl/repos/openearthtools/trunk/matlab/applications/vtools/D3D/fcn/colorbarlegend_V.m $
%
function varargout = colorbarlegend_V(varargin)
...
set(findall(AX,'-property','FontSize'),'FontSize',OPT.CBlegendFontSize)
