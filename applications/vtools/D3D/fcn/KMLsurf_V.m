...
%$Author: chavarri $
%$Id: KMLsurf_V.m 16571 2020-09-08 12:39:17Z chavarri $
%$HeadURL: https://svn.oss.deltares.nl/repos/openearthtools/trunk/matlab/applications/vtools/D3D/fcn/KMLsurf_V.m $
%
function varargout = KMLsurf_V(lat,lon,z,varargin)
...
%      [clrbarstring,pngNames] = KMLcolorbar(OPT);
    [clrbarstring,pngNames] = KMLcolorbar_V(OPT);
