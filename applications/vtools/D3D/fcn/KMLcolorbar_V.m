...
%$Author: chavarri $
%$Id: KMLcolorbar_V.m 16571 2020-09-08 12:39:17Z chavarri $
%$HeadURL: https://svn.oss.deltares.nl/repos/openearthtools/trunk/matlab/applications/vtools/D3D/fcn/KMLcolorbar_V.m $
%
function varargout = KMLcolorbar_V(varargin)
...
%     pngNames{end+1} = KML_colorbar(OPT);
    pngNames{end+1} = KML_colorbar_V(OPT);
end
