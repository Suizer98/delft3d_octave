...
%$Author: chavarri $
%$Id: fig_Q_analysis_vertical.m 18342 2022-08-30 09:28:23Z chavarri $
...
function fig_Q_analysis_vertical(in_p)
...
% han.p(kr,kc,1)=plot(data_rws.time(~idx_nan),data_rws.waarde(~idx_nan),'parent',han.sfig(kr,kc),'color',prop.c1,'linewidth',prop.lw1,'linestyle',prop.ls1,'marker',prop.m1);
% han.p(kr,kc,1)=scatter(time_q_year_max,q_year_max,prop.ms1,prop.mt1,'filled','parent',han.sfig(kr,kc),'markerfacecolor',prop.mf1);
han.p(kr,kc,1)=plot(data_station.waarde(~idx_nan),data_station.time(~idx_nan),'parent',han.sfig(kr,kc),'color',prop.c1,'linewidth',prop.lw1,'linestyle',prop.ls1,'marker',prop.m1);
han.p(kr,kc,1)=scatter(q_year_max,time_q_year_max,prop.ms1,prop.mt1,'filled','parent',han.sfig(kr,kc),'markerfacecolor',prop.mf1);
