...
%$Author: chavarri $
%$Id: fig_Q_matrix.m 18455 2022-10-17 05:25:35Z chavarri $
%$HeadURL: https://svn.oss.deltares.nl/repos/openearthtools/trunk/matlab/applications/vtools/data_stations/fig_Q_matrix.m $
%
%MATLAB BUGS:
...
cbar(kr,kc).label='discharge Q [m^3/s]';
...
lims.c(kr,kc,1:2)=lims_q;
xlabels{kr,kc}='year';
ylabels{kr,kc}='# days below Q';
...
%% PLOT
[x_m,y_m,nodes]=meshgridNodes(tim,1:1:size(q,1));

kr=1; kc=1;    
surf(x_m,y_m,q,'parent',han.sfig(kr,kc),'edgecolor','none')
