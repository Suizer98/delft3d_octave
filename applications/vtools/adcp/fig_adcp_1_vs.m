...
%$Author: chavarri $
%$Id: fig_adcp_1_vs.m 17478 2021-09-09 15:44:11Z chavarri $
%$HeadURL: https://svn.oss.deltares.nl/repos/openearthtools/trunk/matlab/applications/vtools/adcp/fig_adcp_1_vs.m $
%
%MATLAB BUGS:
...
han.p(kr,kc,1)=plot(s,data_plot,'parent',han.sfig(kr,kc),'color','k','linewidth',prop.lw1,'linestyle',prop.ls1,'marker',prop.m1);
