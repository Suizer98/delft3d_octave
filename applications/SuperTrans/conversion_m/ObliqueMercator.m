function [x2,y2]=ObliqueMercator(x1,y1,a,finv,latc,lonc,alphac,gammac,kc,ec,nc,iopt)
% OBLIQUEMERCATOR   One line description (oblique mercator?)
%
%   More detailed description
%
%   Syntax:
%   [x2,y2]=ObliqueMercator(x1,y1,a,finv,latc,lonc,alphac,gammac,kc,ec,nc,iopt)
%
%   Input:
%   x1
%   y1
...
% $Id: ObliqueMercator.m 3224 2010-11-02 16:02:57Z mol $
% $Date: 2010-11-03 00:02:57 +0800 (Wed, 03 Nov 2010) $
% $Author: mol $
% $Revision: 3224 $
% $HeadURL: https://svn.oss.deltares.nl/repos/openearthtools/trunk/matlab/applications/SuperTrans/conversion_m/ObliqueMercator.m $
% $Keywords: $
