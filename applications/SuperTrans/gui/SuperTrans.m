...
% $Id: SuperTrans.m 11503 2014-12-03 15:07:35Z ormondt $
% $Date: 2014-12-03 23:07:35 +0800 (Wed, 03 Dec 2014) $
% $Author: ormondt $
% $Revision: 11503 $
% $HeadURL: https://svn.oss.deltares.nl/repos/openearthtools/trunk/matlab/applications/SuperTrans/gui/SuperTrans.m $
% $Keywords: $
...
if strcmpi(CS.type,'projected')
    ...
    switch proj_conv.method.code
        ...
        case{9805}
            pars{1}='Longitude of false origin';
            pars{3}='Easting at false origin';
            pars{4}='Northing at false origin';
            pars{5}='Latitude of 1st standard parallel';
    ...
    switch proj_conv.method.code
        case{9801,9802,9803,9804,9805,9807,9808,9809,9812,9815}
            handles.ConversionOK=1;
        otherwise
