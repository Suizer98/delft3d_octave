...
function stat = test_RY_Matrices()
    ...
    stat.desc = '';
    try
        ry = yml.read([PTH_PRIMITIVES() 'matrices.yaml']);
...
function stat = test_RY_FloatingPoints()
    ...
    stat.desc = '';
    try
        ry = yml.read([PTH_PRIMITIVES() 'floating_points.yaml']);
...
function stat = test_RY_Indentation()
    ...
    stat.desc = '';
    try
        ry = yml.read([PTH_PRIMITIVES() 'indentation.yaml']);
...
function stat = test_RY_SequenceMapping()
    ...
    stat.desc = '';
    try
        ry = yml.read([PTH_PRIMITIVES() 'sequence_mapping.yaml']);
...
function stat = test_RY_Simple()
    ...
    stat.desc = '';
    try
        ry = yml.read([PTH_PRIMITIVES() 'simple.yaml']);
...
function stat = test_RY_Time()
    ...
    stat.desc = '';
    try
        ry = yml.read([PTH_PRIMITIVES() 'time.yaml']);
...
function stat = test_RY_TimeVariants()
    ...
    stat.desc = '';
    try
        ry = yml.read([PTH_PRIMITIVES() 'time_variants.yaml']);
...
function stat = test_RY_Import()
    ...
    stat.desc = '';
    try
        ry = yml.read([PTH_IMPORT() 'import.yaml']);
...
function stat = test_RY_ImportDef()
    ...
    stat.desc = '';
    try
        ry = yml.read([PTH_IMPORT() 'import_def.yaml']);
...
function stat = test_RY_ImportNonex()
    ...
    try
        try
            ry = yml.read([PTH_IMPORT() 'import_nonex.yaml'],1);            %#ok<NASGU>
        catch ex
...
function stat = test_RY_Inheritance()
    ...
    stat.desc = '';
    try
        ry = yml.read([PTH_INHERITANCE() 'inheritance.yaml']);
...
function stat = test_RY_InheritanceMultiple()
    ...
    stat.desc = '';
    try
        ry = yml.read([PTH_INHERITANCE() 'inheritance_multiple.yaml']);
...
function stat = test_RY_InheritanceLoop()
    ...
    try
        try
            ry = yml.read([PTH_INHERITANCE() 'inheritance_loop.yaml']);     %#ok<NASGU>
        catch ex
...
function stat = test_RY_Whitespaces()
    ...
    stat.desc = '';
    try
        ry = yml.read([PTH_PRIMITIVES() 'whitespaces.yaml']);
...
function stat = test_RY_usecase_01()
    ...
    stat.desc = '';
    try
        ry = yml.read([PTH_PRIMITIVES() 'usecase_struct_01.yaml']);
