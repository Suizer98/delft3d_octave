function [dbfData, dbfFieldNames] = dbf_read(filename, records2read, requestedFieldNames)
%DBF_READ Read the specified records and fields from a DBF file.
%
%   [DATA, NAMES] = DBF_READ(FILE) reads numeric, float, character and date
%   data and field names from a DBF file, FILE.
%
%   [DATA, NAMES] = DBF_READ(FILE, RECORDS2READ) reads only the record
%   numbers specified in RECORDS2READ, a scalar or vector.
%
%   [DATA, NAMES] = DBF_READ(FILE, RECORDS2READ, REQUESTEDFIELDNAMES) reads
...
% $Revision: 7058 $   $Date: 2012-07-30 15:58:29 +0800 (Mon, 30 Jul 2012) $
